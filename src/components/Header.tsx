...
>(function Header({ className, ...props }, ref) {
  ...
  return (
    <motion.div
      ...
      className={clsx(
        className,
        'fixed inset-x-0 top-0 z-50 flex h-14 items-center justify-between gap-6 px-4 transition sm:px-6 lg:left-72 lg:z-30 lg:px-8 xl:left-80',
    ...
    >
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="flex gap-4 items-center">
          <MobileSearch />
          <ThemeToggle />
          <div className="block lg:hidden min-[530px]:mr-[-12px]">
            <LanguageSwitcher />
          </div>
        </div>
        <div className="hidden min-[530px]:contents">
          <Button href="https://poplab.ai">Go to PopLab</Button>
        </div>
      </div>
    </motion.div>
  )
